...
export class passwordReset1677179901068 implements MigrationInterface {
  name = 'passwordReset1677179901068';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX \`IDX_36e929b98372d961bb63bd4b4e\` ON \`password_reset\``,
    );
